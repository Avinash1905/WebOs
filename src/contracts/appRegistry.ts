...
export const BUILTIN_APPLICATIONS: AppDefinition[] = [
  ...
  },
  {
    ...
    icon: FileText,
    iconColor: '#38bdf8',
    description: 'Professional VS Code-like WebOS Code Editor with syntax highlighting, file tree, minimap, command palette, and integrated terminal.',
    version: '2.1.0',
    keywords: ['vscode', 'code', 'editor', 'developer', 'ide', 'syntax', 'terminal'],
    defaultBounds: { width: 960, height: 640 },
    showOnDesktop: true,
    isPinnedToTaskbar: true,
    isFavorite: true,
  },
  ...
  },
  {
    ...
    icon: CalcIcon,
    iconColor: '#f472b6',
    description: 'Standard and scientific mathematical calculation utility with expression parser and unit converter.',
    version: '2.0.0',
    keywords: ['math', 'calculate', 'numbers', 'arithmetic', 'scientific', 'unit'],
    defaultBounds: { width: 440, height: 560 },
    minWidth: 360,
    minHeight: 480,
    showOnDesktop: true,
    isPinnedToTaskbar: true,
  ...
  },
  {
    ...
    icon: FileText,
    iconColor: '#10b981',
    description: 'Full-featured spreadsheet editor with formulas, dependency graph, formatting, SVG charts, and multi-sheet workbooks.',
    version: '2.0.0',
    keywords: ['excel', 'sheets', 'grid', 'table', 'formulas', 'charts', 'data', 'spreadsheet'],
    defaultBounds: { width: 960, height: 620 },
    showOnDesktop: true,
    isPinnedToTaskbar: true,
    isFavorite: true,
  },
  {
    ...
    icon: Monitor,
    iconColor: '#8b5cf6',
    description: 'Relational database management app with schema browser, data grid, record editor, and SQL query console.',
    version: '2.0.0',
    keywords: ['sql', 'database', 'tables', 'query', 'schema', 'records', 'indexeddb'],
    defaultBounds: { width: 920, height: 600 },
    showOnDesktop: true,
    isPinnedToTaskbar: true,
    isFavorite: true,
  },
  {
    ...
    icon: Activity,
    iconColor: '#ef4444',
    description: 'Live CPU, memory usage graphs, and active process tree monitor integrated with WebOS Kernel.',
    version: '2.0.0',
    keywords: ['task manager', 'processes', 'cpu', 'ram', 'performance', 'metrics', 'monitor'],
